            ...
            # set corners manually 
                ...
                if intrinsics: 
                    if len(self.click_coordinates) == 4:
                        ...
                        self.training_points['objpoints'].append(self.objp)
                        self.training_points["imgpoints"].append(corners2_interp)
                        self.draw_chessboard_corners(self.img, corners2_interp)
                    else:
                ...
                if not intrinsics: 
                    if len(self.click_coordinates) == 4:
                        interpolated_corners = self.interpolate_corners(self.click_coordinates)
                        corners2_interp = cv.cornerSubPix(self.gray, interpolated_corners, (11, 11), (-1, -1), self.criteria)
